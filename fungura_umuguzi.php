    ...
    <form method="POST" autocomplete="off">
      <div class="form-group">
        ...
        <label for="name">ijambo banga</label>
         <input type="password" id="name" name="b" placeholder="Injiza ijambo banga"  pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d).{8,}$" title="ijambo banga rigomba kuba rifite byibura inyuguti 8, ikabamo inyuguti nkuru, nto, ni imibare" required">
      </div>
      <div class="form-group">
...
if(isset($_POST['ok'])){
    ...
    $insert=mysqli_query($con,"INSERT INTO umuguzi(amazina,ibanga,emeri,terefone,umurenge)VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]')");

    IF($insert){
    ?>
    <script type="text/javascript">
    alert("Muguzi urakoze kwiyandikisha ngaho kanda kwinjira");
